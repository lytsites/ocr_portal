...
PROGRESS_MIN_STEP = env_int("PROGRESS_MIN_STEP", 50, min_value=1)
PROGRESS_MIN_INTERVAL_SEC = env_float("PROGRESS_MIN_INTERVAL_SEC", 3.0, min_value=0.1)
STAGE_PROGRESS_MIN_INTERVAL_SEC = env_float("STAGE_PROGRESS_MIN_INTERVAL_SEC", 2.0, min_value=0.1)
